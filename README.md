# memebank organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`memebank`](https://github.com/memebank).

## Canonical organization links

- GitHub organization: https://github.com/memebank
- Public organization defaults: https://github.com/memebank/.github
