...
3. Review linked pull requests, issues, Linear work, related repositories in `memebank`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
